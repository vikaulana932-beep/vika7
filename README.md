...
<body>
    ...
    <div class="modal-overlay" id="modal">
        <div class="modal-content">
            ...
            <button class="buy-btn" onclick="alert('Дякуємо за покупку!')">ПРИДБАТИ ЗАРАЗ</button>
        </div>
    </div>

    <script>
        const games = [
            { id: 1, name: "Cyberpunk 2077", price: "899 грн", rating: 5, img: "https://images.unsplash.com", desc: "Відкритий світ майбутнього у Найт-Сіті." },
            { id: 2, name: "Elden Ring", price: "1599 грн", rating: 5, img: "https://images.unsplash.com", desc: "Епічна пригода в Міжзем'ї від FromSoftware." },
            { id: 3, name: "The Witcher 3", price: "499 грн", rating: 5, img: "https://images.unsplash.com", desc: "Легендарна історія Геральта з Рівії." },
            { id: 4, name: "God of War", price: "1199 грн", rating: 4, img: "https://images.unsplash.com", desc: "Шлях Кратоса та Атрея у світі скандинавських міфів." }
        ];
